...
angular.module('starter.dashs', [])
.controller('dashController',function($scope, $timeout, $stateParams, ionicMaterialMotion, ionicMaterialInk,$location, $firebase , $rootScope, $ionicPopup, $state,$ionicLoading,Categories) {
